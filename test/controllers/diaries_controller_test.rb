...
class DiariesControllerTest < ActionController::TestCase
  ...
  test "should create diary" do
    assert_difference('Diary.count') do
      post :create, diary: { contents: @diary.contents, image: @diary.image, title: @diary.title, user_id: @diary.user_id }
    end
  ...
  test "should update diary" do
    patch :update, id: @diary, diary: { contents: @diary.contents, image: @diary.image, title: @diary.title, user_id: @diary.user_id }
    assert_redirected_to diary_path(assigns(:diary))
  end
